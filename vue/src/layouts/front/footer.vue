  ...
  <main v-if="config">
    <div class="front-footer mt-10 px-3 md:px-0" v-if="config.copyright.showXjAvatar">
      <div class="el-divider el-divider--horizontal">
        <div class="el-divider__text is-center rounded-lg bg-gradient-to-r from-sky-500 to-indigo-500 text-white py-1 opacity-100">
          {{ config.copyright.ad }}
        </div>
      </div>
      <div class="flex flex-col items-center justify-center pt-10 mb-5">
        <img src="/images/bms.jpg" class="h-32 rounded-lg object-cover" />
        <div class="text-center mt-3 text-base font-bold">
          ...
          <a href="https://www.banmashou.com" class="text-[#ff7675] font-bold">斑马兽</a><br /><button
            ...
            type="button">
            <span><i class="fas fa-play-circle"></i> banmashou.com </span>
          </button>
        </div>
      </div>
    </div>
